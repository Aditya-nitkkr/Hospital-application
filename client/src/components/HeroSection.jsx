...
export const HeroSection = () => {
    ...
    return (<section className="hero-section">
        <div className="container grid grid-two-cols main-sec">
            <div className="hero-content">
                ...
                <div className="search-wrapper">
                    <input type="text" className="search-bar" value={userInputInSearch} onChange={handleUserInput} placeholder="Search here.." />
        ...
        {/* <div className="custom-shape-divider-bottom-1744482686">
